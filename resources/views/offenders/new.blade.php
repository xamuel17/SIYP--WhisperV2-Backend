  ...
  <div class="page-content-wrapper">
    <div class="page-content">
      ...
      <div class="page-breadcrumb d-none d-md-flex align-items-center mb-3">
        <div class="breadcrumb-title pr-3">New Sex Offender</div>
        <div class="pl-3">
        ...
        <div class="col-12 col-lg-12">
          <div class="card border-lg-top-primary">
            <div class="card-body p-5">
              ...
              <form method="post" action="{{ route('offenders.create') }}" enctype="multipart/form-data">
                  @csrf
                  <div class="form-body">
                    <div class="form-row">
                      <div class="form-group col-md-6">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control border-left-0" placeholder="" name="offender_name" required value="{{ @old('offender_name') }}">
                        </div>
                      </div>
                      <div class="form-group col-md-6">
                        <label>Title</label>
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-6">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control border-left-0" placeholder="" name="offence" required value="{{ @old('offence')}}">
                        </div>
                      </div>
                      <div class="form-group col-md-6">
                        <label>Photo</label>
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-6">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control border-left-0" placeholder="" name="source_url" value="{{ @old('source_url')}}">
                        </div>
                      </div>
                    </div>

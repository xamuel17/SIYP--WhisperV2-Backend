  ...
  <div class="page-content-wrapper">
    <div class="page-content">
      ...
      <div class="page-breadcrumb d-none d-md-flex align-items-center mb-3">
        <div class="breadcrumb-title pr-3">View Rule</div>
        <div class="pl-3">
        ...
        <div class="col-12 col-lg-12">
          <div class="card border-lg-top-primary">
            <div class="card-body p-5">
              ...
              <form method="post" action="{{ route('rules.save', ['ruleId' => $rule->id]) }}">
                  @csrf
                  <div class="form-body">
                    ...
                    <button type="submit" class="btn btn-primary px-5">Save Rule</button>
                  </div>
                </form>
            </div>
          </div>

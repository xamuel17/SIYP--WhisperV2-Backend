<div class="sidebar-wrapper" data-simplebar="true">
  <div class="sidebar-header">
    <div class="">
      <img src="{{ asset('assets/images/whisper-icon.png') }}" class="logo-icon-2" alt="" />
    </div>
    <div>
      <h4 class="logo-text">Whisper</h4>
    </div>
  ...
  <ul class="metismenu" id="menu">
    <li>
      <a href="{{ route('dashboard') }}">
        <div class="parent-icon icon-color-9"><i class="bx bx-home-alt"></i>
        </div>
    ...
    <li>
      <a href="{{ route('harmspot.index') }}">
        ...
        <div class="menu-title">Harm Spots</div>
      </a>
    </li>

    <li>
      <a href="{{ route('distress-message.browse') }}">
        <div class="parent-icon icon-color-6"><i class="bx bx-error"></i>
        </div>
        <div class="menu-title">Distress Messages</div>
      </a>
    </li>

    <li>
      <a href="{{ route('offenders.browse') }}">
        <div class="parent-icon icon-color-1"><i class="bx bx-x"></i>
        </div>
        <div class="menu-title">Sex Offenders</div>
      </a>
    </li>
    ...
    <li>
      <a href="{{ route('rules.browse') }}">
        <div class="parent-icon icon-color-10"><i class="bx bx-comment"></i>
        </div>
        <div class="menu-title">App Rules</div>
      </a>
    </li>
    <li>
    ...
    <li>
      <a href="{{ route('admin.change-password') }}">
        <div class="parent-icon icon-color-7"><i class="bx bx-lock-open"></i>
        </div>
    ...
    <li>
      <a href="{{ route('post-reports') }}">
        <div class="parent-icon icon-color-1"><i class="bx bx-comment"></i>
        </div>
        <div class="menu-title">Post Reports</div>
      </a>
    </li>
    ...
    <li>
        ...
        <div class="parent-icon icon-color-8"><i class="bx bx-power-off"></i>
        </div>
